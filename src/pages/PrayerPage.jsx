      ...
      <div className="bg-card border border-border rounded-2xl w-full max-w-lg shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1.5">
                Día <span className="text-red-700 dark:text-red-400">*</span>
              </label>
              <div className="relative">
                <select
                  value={form.dayOfWeek}
                  onChange={(e) => set("dayOfWeek", e.target.value)}
                  className="w-full appearance-none bg-background border border-border text-foreground text-sm rounded-lg px-3 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
            ...
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1.5">
                Inicio <span className="text-red-700 dark:text-red-400">*</span>
              </label>
              <Input
                type="time"
  ...
  return (
    <div
      className={`group flex items-start gap-3 p-3 rounded-xl border transition-all ${
        item.is_active
          ? "bg-muted/50 border-border hover:bg-muted/50 hover:border-muted-foreground/40"
      ...
      {canEdit && (
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
          ...
          <button
            ...
            className="p-1.5 rounded-md text-muted-foreground hover:text-red-700 dark:text-red-400 hover:bg-red-500/10 transition-colors"
          >
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">Días de Oración</h1>
          ...
          {byDay.map((day) => (
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  <span
                    className={`font-semibold text-sm ${day.value === TODAY_DOW ? "text-orange-700 dark:text-orange-300" : "text-foreground"}`}
                  >
                    {day.label}
                  </span>
                  {day.value === TODAY_DOW && (
                    <span className="text-xs px-1.5 py-0.5 rounded-full bg-orange-500/20 text-orange-700 dark:text-orange-400 font-medium">
                      Hoy
                    </span>
                  )}
                </div>
              ...
              {canEdit && (
                <div className="px-3 pb-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-dashed border-border text-xs text-muted-foreground hover:border-orange-500/40 hover:text-orange-700 dark:text-orange-400 transition-colors"
                  >
